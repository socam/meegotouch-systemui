...
StatusAreaView::StatusAreaView(StatusArea *controller) :
    ...
    screenPagerStatus(new ScreenPagerStatus(controller))
{
    ...
    //screenPagerStatus = new ScreenPagerStatus();
    new ScreenPagerStatusAdaptor(screenPagerStatus);
    QDBusConnection::sessionBus().registerService("zed.socam.ScreenPagerStatus");
    QDBusConnection::sessionBus().registerObject("/screenpagerstatus", screenPagerStatus);
...
void StatusAreaView::setupTestability()
{
    ...
    screenPagerStatus->setParent(portraitWidget);
}
...
QGraphicsLinearLayout* StatusAreaView::createPortraitLayout()
{
    ...
    layout->addStretch();
    layout->addItem(screenPagerStatus);
    layout->addStretch();
