...
ScreenPagerStatus::ScreenPagerStatus(QGraphicsItem *parent) :
    StatusIndicator(parent)
{
    setCurrentPage(0);
}
...
ScreenPagerStatus::~ScreenPagerStatus() {

}

void ScreenPagerStatus::setCurrentPage(uint value) {

    cout<< "ScreenPagerStatus::setCurrentPage:"<<value<<endl;
    switch(value) {
        case 0: //first page
            setStyleNameAndUpdate(QString(metaObject()->className()) + "First");
            break;
        case 1: //app launcher
            setStyleNameAndUpdate(QString(metaObject()->className()) + "Launcher");
            break;
        case 2: //app switcher
            setStyleNameAndUpdate(QString(metaObject()->className()) + "Switcher");
            break;
        default:
            setStyleNameAndUpdate(metaObject()->className());
            break;
