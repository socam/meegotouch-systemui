...
class ScreenPagerStatus: public StatusIndicator
{
    Q_OBJECT
    M_CONTROLLER(ScreenPagerStatus)

public:
    /*!
     * Constructs a ScreenPagerStatus.
     *
     * \param parent parent MWidget
     */
    //ScreenPagerStatus(QObject* parent);
    explicit ScreenPagerStatus(QGraphicsItem *parent = NULL);
